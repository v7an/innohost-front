  ...
  <div class="bg-gray-900">
    <main>
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
          <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
            ...
            <div data-aos="fade-right" class="mt-10 flex items-center gap-x-6">
              <a href="https://panel.innohost.pro" class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Commencer</a>
      ...
      <div data-aos="fade-down" class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
          <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Utilisez notre hébergeur dès aujourd'hui.</h2>
          <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">Améliorer la sécurité et l'efficacité de votre projet en intégrant dès aujourd'hui notre hébergeur de confiance.</p>
